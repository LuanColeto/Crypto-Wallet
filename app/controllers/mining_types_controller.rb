class MiningTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mining_type.save
        format.html { redirect_to @mining_type, notice: 'Novo tipo de mineração foi criada com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @mining_type.update(mining_type_params)
        format.html { redirect_to @mining_type, notice: 'Tipo de mineração foi atualizado com sucesso!' }
  ...
  def destroy
    @mining_type.destroy
    respond_to do |format|
      format.html { redirect_to mining_types_url, notice: '' }
